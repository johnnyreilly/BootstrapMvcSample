...
namespace BootstrapSupport
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString BsEditor(this HtmlHelper html, PropertyInfo propInfo, object additionalViewData)
        {
            ...
            return html.Editor(propInfo.Name, additionalViewData);
        }
